...
public interface TransformOperation {
   ...
   */
  Value applyToLocalView(@Nullable ValueOrBuilder previousValue, Timestamp localWriteTime);
   ...
   */
  Value applyToRemoteDocument(@Nullable ValueOrBuilder previousValue, Value transformResult);
   ...
   */
  @Nullable
  Value computeBaseValue(@Nullable ValueOrBuilder previousValue);
}
