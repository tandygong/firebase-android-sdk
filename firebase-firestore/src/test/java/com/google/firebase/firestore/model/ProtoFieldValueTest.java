...
public class ProtoFieldValueTest {
  private final Date date1;
  private final Date date2;

  public ProtoFieldValueTest() {
  ...
  private PrimitiveValue wrapPrimitive(Object o) {
    ...
    if (o instanceof Integer) {
      return new PrimitiveValue(integerValue((Integer) o));
    }
  ...
  private Value integerValue(int i) {
  ...
  //        .addEqualityGroup(
  //            wrap(0.0 / 0.0), wrap(Double.longBitsToDouble(0x7ff8000000000000L)),
  // DoubleValue.NaN)
  ...
  //        .addEqualityGroup(wrapObject(map("bar", 1, "foo", 2)), wrapObject(map("foo", 2, "bar",
  // 1)))
